...
export type ChartDatum = { label: string; value: number; display: string; colorKey?: string };
...
export const faithWritings: FaithWriting[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "question", text: "Doesn't the fact that Abraham and Jacob tithed before the Law was even given prove it's a timeless principle, not just an Old Covenant rule?" },
      { type: "p", text: "Look closer at both accounts and the case gets weaker, not stronger. Abraham's tithe (Genesis 14:20) was a one-time gift of war spoils to Melchizedek, not his personal income, and there's no record he ever tithed again from his own household's increase." },
      { type: "p", text: "Jacob's tithe (Genesis 28:20-22) is even less of a model to build a doctrine on. It's explicitly conditional: “If God will be with me and will keep me... then the Lord will be my God, and this stone... will be God's house, and of all that You give me I will give a tenth to You.” That's a vow with an “if,” not a settled conviction, and Scripture never records him actually paying it. A one-time gift of plunder and an unfulfilled conditional vow are thin ground for building a doctrine that every believer owes 10% of income forever." },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "Acts 9 tells the story of Paul's conversion on the road to Damascus, and the very next thing the text records is **Acts 9:20**: “Now for several days he was with the disciples who were in Damascus, and immediately he began to proclaim Jesus in the synagogues, saying, ‘He is the Son of God.’” This isn't a detail from years later, it's the verse that directly follows his conversion." },
      { type: "p", text: "The word translated “proclaim” there is *kēryssō*, the same word used throughout the New Testament specifically for the authoritative public proclamation of the gospel, formal heralding, not casual conversation. Paul wasn't waiting on anyone's release. **He started within days.**" },
  ...
  {
    slug: "does-tithing-break-a-financial-curse",
    category: "topical-study",
    title: "Does Tithing Break a Financial Curse? What a Century of Data Actually Shows",
    dek: "A specific, testable promise from Word of Faith, NAR, and prosperity teaching, tithe 10% and God will lift the curse off your finances, checked against a century of real economic data.",
    author: "Juston Warthen",
    date: "September 2026",
    body: [
      { type: "p", text: "A specific promise circulates across Word of Faith, apostolic, and other prosperity-adjacent circles: tithe 10% of your income to your local church, and God will break the curse over your finances, open doors, and financially bless you. Not a general encouragement to give generously, a specific financial mechanism, obedience in, prosperity out." },
      { type: "p", text: "Before looking at any data, one thing needs to be said plainly: **this is not an article about why any race or people group is or isn't wealthy.** The wealth gaps in America have clear, well-documented causes that have nothing to do with how much anyone gave their church. Slavery denied formerly enslaved people the promised land grants that could have built generational wealth. Decades of legally enforced redlining blocked Black families from mortgages and homeownership until the Fair Housing Act in 1968. Employment and wage discrimination compounded both. That's the settled, documented history, and nothing below is an attempt to explain it away or blame it on giving habits." },
      { type: "p", text: "What this article is actually testing is narrower: **does the specific mechanism preached, tithe faithfully and God will financially bless you or remove a curse, show up anywhere in the data for the group with the longest, most consistently documented tithing tradition in American religious history?**" },

      { type: "question", text: "Which group has the longest documented tithing tradition?" },
      { type: "p", text: "The Black Protestant church. W.E.B. Du Bois's 1903 study *The Negro Church* documented detailed records of Black Baptist congregations' tithes and offerings going back to the 1870s, including $100,337 given to missions by Black Baptist churches in 1902 alone. Lincoln and Mamiya's landmark 1990 study, based on interviews with over 1,800 Black clergy, traced this same tradition of sacrificial giving and mutual aid through the entire 20th century." },
      { type: "p", text: "It hasn't slowed down. A 2024 study of 1,039 evangelicals by Grey Matter Research found evangelicals of color, Black, Latino, Native American, and Asian-American, give a significantly higher and *rising* share of income than white evangelicals, whose giving is falling. This is happening inside denominations, like the National Baptist Convention and the Church of God in Christ, where roughly half of members earn under $30,000 a year and only about 9% earn six figures." },

      { type: "question", text: "What does the current landscape actually look like, by race?" },
      { type: "p", text: "Before going back a century, here's where things stand right now. Three separate, current data sets, laid side by side: household income, net worth, and giving." },
      {
        type: "chart",
        title: "Median Household Income by Race/Ethnicity (2023)",
        sourceNote: "U.S. Census Bureau, Income in the United States: 2023.",
        data: [
          { label: "Asian", value: 112800, display: "$112,800" },
          { label: "White", value: 89050, display: "$89,050" },
          { label: "Hispanic", value: 65540, display: "$65,540" },
          { label: "Black", value: 56490, display: "$56,490" },
        ],
      },
      {
        type: "chart",
        title: "Median Net Worth by Race/Ethnicity (2022)",
        sourceNote: "Federal Reserve, Survey of Consumer Finances, 2022.",
        data: [
          { label: "Asian", value: 536000, display: "$536,000" },
          { label: "White", value: 285000, display: "$285,000" },
          { label: "Hispanic", value: 61600, display: "$61,600" },
          { label: "Black", value: 44900, display: "$44,900" },
        ],
      },
      { type: "p", text: "Giving isn't tracked the same uniform way across every group, so rather than force four numbers into a shape the research doesn't actually offer, here's what's specifically measured. The clearest race-based comparison tracks share of *wealth*, not income, given to charity over time:" },
      {
        type: "chart",
        title: "Share of Median Wealth Given to Charity, Black vs. White",
        sourceNote: "Urban Institute, based on Panel Study of Income Dynamics data, 2010-2016. White giving held flat near 2% across the same years.",
        data: [
          { label: "Black, 2010", value: 6, display: "6%", colorKey: "Black" },
          { label: "White, 2010", value: 2, display: "2%", colorKey: "White" },
          { label: "Black, 2013", value: 11, display: "11%", colorKey: "Black" },
          { label: "White, 2013", value: 2, display: "2%", colorKey: "White" },
          { label: "Black, 2016", value: 8, display: "8%", colorKey: "Black" },
          { label: "White, 2016", value: 2, display: "2%", colorKey: "White" },
        ],
      },
      { type: "p", text: "A few more specific, sourced data points that don't fit neatly into a four-way chart, but round out the picture: Black households give away **25% more of their income per year than white households** (Urban Institute). African-American donors report giving an average of **13% of income to their place of worship** (Lilly Family School of Philanthropy). Hispanic donors are the most likely of any group to name their place of worship as the single nonprofit cause they support most (45%). Roughly two-thirds of Black and Hispanic households give to charity in a given year, versus about half of Asian households." },
      { type: "p", text: "Put together: the group giving away the largest share of what it has, by every one of these specific measures, is sitting at the bottom of both the income and net worth rankings. The group with the most wealth to work with, Asian households, does not show up at the top of any of these giving measures. That's the entire landscape the rest of this argument is built on." },

      { type: "question", text: "So does the financial outcome match the faithfulness?" },
      { type: "p", text: "Here's where the promise runs into a century of real numbers. Research from Princeton and NBER economists, spanning 1860 to 2020, puts the white-to-Black wealth ratio at 10 to 1 in 1920, 7 to 1 in 1950, and 6 to 1 today. That's still a massive gap, essentially unmoved in relative terms across a full century of unbroken, well-documented, sacrificial tithing." },
      { type: "p", text: "The one stretch where real relative progress happened was 1960 to 1980, when the wealth ratio closed five times faster than in any other period. Every economic historian studying this attributes that specific window to the Civil Rights Act, the Fair Housing Act, and the dismantling of legal segregation, not to a change in how much anyone was giving their church. Giving was already high before that window, during it, and after it. Outside those twenty years, across the other eighty-plus years of the century, the ratio has been flat or, since the 1980s, widening again." },
      { type: "p", text: "If tithing functioned as a financial-blessing mechanism the way it's preached, a century of unbroken faithful giving from one of history's most devoted tithing traditions should show it somewhere in that line. It doesn't. The only real movement traces to secular policy, not sown seed." },

      { type: "question", text: "Is this just an American pattern?" },
      { type: "p", text: "No, and that matters, because it rules out a lot of the obvious American-specific explanations. Prosperity theology, tithing emphasis included, has spread rapidly across Pentecostal movements in Sub-Saharan Africa over the past two decades. Over that same stretch, Africa is the one region in the world where poverty has *increased*, not decreased, according to research examining prosperity theology's socioeconomic impact there. Two populations, separated by an ocean and most of a century, both under heavy tithing-for-blessing teaching, and neither shows the promised financial dividend. If anything, the direction runs the other way." },

      { type: "question", text: "So what does this actually prove?" },
      { type: "p", text: "It doesn't prove giving makes anyone poor, and it isn't an argument about race explaining economic outcomes; the real causes of the wealth gap are documented, structural, and predate any of this data by a century. What it does show is that a specific, testable promise, tithe faithfully and God will lift the curse off your finances, fails to appear as a measurable financial mechanism in the largest, longest-running natural experiment available to check it against. A century of faithful giving from the group most known for faithfully keeping this teaching produced no financial dividend distinguishable from a policy-driven civil rights window that had nothing to do with tithing at all." },
      { type: "p", text: "If the wealth gap in your life or your community traces to history and policy rather than a lack of faith or insufficient giving, that should be freeing, not one more reason to give money you don't have chasing a mechanism the data can't find." },
      { type: "p", text: "What are your thoughts?" },
    ],
  },
];
